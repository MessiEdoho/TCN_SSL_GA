#!/bin/bash -l
#SBATCH --job-name=tune_msattn_dry
...
# script. With MAX_EPOCHS=20 and early stopping patience 5, each trial runs
# ~8-20 epochs. 1-day walltime is generous for two trials on a GPU.
#SBATCH -t 1-00:00:00
...
# Purpose: verify script starts, loads M3 backbone HPs from the M3 output
# directory, instantiates MultiScaleTCNWithAttention with the frozen-
# backbone protocol, reaches the training loop, and writes all six outputs
# without consuming a full 50-trial budget.
