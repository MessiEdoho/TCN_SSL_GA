...
edf_dir        = Path(r'/home/people/22206468/scratch/EEG_TRAINING_5')           # folder containing all .edf files
annotation_dir = Path(r'/home/people/22206468/scratch/seizure_times_updated')    # folder containing all matching .xlsx files
output_dir     = Path(r'/home/people/22206468/scratch/TRAIN_DATA_5')       # root output folder; seizure/ and non_seizure/ created inside
...
log = logging.getLogger('eeg_pipeline_train_5')        # create a named logger for this pipeline
...
file_handler = logging.FileHandler(            # handler that writes log messages to a file
    output_dir / 'train_5_pipeline.log',               # log file lives next to the output segments
...
log.info(f'  Log file:       {output_dir / "train_5_pipeline.log"}')  # log the log file path itself
