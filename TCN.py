...
def main():
    ...
    # If a previous run saved a best checkpoint (e.g. job killed by Slurm
    # walltime), load model, optimiser, and scheduler state and continue
    # from the next epoch. To start fresh, delete the checkpoints/ directory.
    resume_ckpt = CKPT_DIR / "tcn_best.pt"
