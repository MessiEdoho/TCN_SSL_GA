...
def main():
    ...
    #   * pfx_helpers : files produced by MultiScaleTCNAttention.save_all_results
    #                   / plot_all_figures, whose internal prefix is hard-coded
    #                   to "ms_attn" and is not overridden by the path-globals
    #                   rebind in _redirect_outputs_to_full_train_eval
    pfx_bespoke = "ms_attn_full_train"
    pfx_helpers = "ms_attn"
    all_outputs = [
